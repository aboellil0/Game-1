...
const TerraGame = () => {
  ...
  const instruments = [
    ...
    },
    {
      ...
      icon: '🔭',
      color: 'bg-purple-500',
      description: 'Views Earth from multiple angles to study clouds and aerosols',
      ...
      <div className="w-full h-screen bg-gradient-to-b from-blue-900 via-blue-700 to-blue-500 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-2xl w-full">
          <div className="text-center mb-6">
            <Satellite className="w-20 h-20 mx-auto mb-4 text-blue-600" />
            <h1 className="text-4xl font-bold text-gray-800 mb-2">TerraQuest</h1>
          ...
          <div className="bg-blue-50 rounded-lg p-6 mb-6">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Learn About NASA&apos;s Terra Satellite!</h2>
            <p className="text-gray-700 mb-4">
              Terra was launched in 1999 and orbits Earth collecting vital climate data. Use arrow keys to pilot the satellite and collect data from its 5 amazing instruments!
            </p>
            <div className="grid grid-cols-2 gap-3 text-sm">
              {instruments.map(inst => (
                <div key={inst.id} className="flex items-center gap-2 bg-white p-2 rounded">
                  <span className="text-2xl">{inst.icon}</span>
                  <span className="font-semibold text-gray-700">{inst.name}</span>
                </div>
              ))}
            </div>
          </div>
    ...
    return (
      <div className="w-full h-screen bg-gradient-to-b from-blue-900 to-blue-600 overflow-auto p-4">
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl p-8 my-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-6">About NASA&apos;s Terra Satellite</h1>
          
          <div className="space-y-6">
            <div className="bg-blue-50 rounded-lg p-6">
              <h2 className="text-2xl font-bold text-gray-800 mb-3">Mission Overview</h2>
              <p className="text-gray-700 leading-relaxed">
                Terra (EOS AM-1) is a flagship satellite launched by NASA in December 1999. It&apos;s part of the Earth Observing System (EOS) and orbits 705 km above Earth, passing over the equator at 10:30 AM local time. Terra completes an orbit every 99 minutes, viewing the entire Earth every 16 days.
              </p>
            </div>

            <div className="grid md:grid-cols-2 gap-4">
              {instruments.map(inst => (
                <div key={inst.id} className={`${inst.color} bg-opacity-10 rounded-lg p-5 border-l-4 ${inst.color}`}>
            ...
            <div className="bg-green-50 rounded-lg p-6">
              <h2 className="text-2xl font-bold text-gray-800 mb-3">Why Terra Matters</h2>
  ...
  if (gameState === 'complete') {
    ...
    const completionRate = (uniqueInstruments / instruments.length * 100).toFixed(0);
      ...
      <div className="w-full h-screen bg-gradient-to-b from-blue-900 to-blue-600 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-2xl w-full">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-6">Great job exploring Earth!</p>
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-green-50 rounded-lg p-4">
                <p className="text-3xl font-bold text-green-600">{uniqueInstruments}/5</p>
                <p className="text-gray-600 text-sm">Instruments</p>
              </div>
              <div className="bg-purple-50 rounded-lg p-4">
                <p className="text-3xl font-bold text-purple-600">{collectedData.length}</p>
            ...
            <p className="text-gray-600 mb-6">{completionRate}% Instrument Coverage</p>
  ...
  return (
    <div className="w-full h-screen bg-gradient-to-b from-black via-blue-900 to-blue-700 relative overflow-hidden">
      ...
      {showFact && (
        <div className="absolute top-24 left-1/2 transform -translate-x-1/2 bg-white rounded-lg shadow-2xl p-4 max-w-md z-20">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-bold text-gray-800">{showFact.name} Collected!</p>
      ...
      <div className="absolute inset-0 mt-16">
        ...
        >
          <div className="absolute inset-0 bg-green-600 opacity-20 rounded-t-full" style={{
        ...
        >
          <Satellite className="w-12 h-12 text-white drop-shadow-lg" />
